...
|12             |[Исследование опроса клиентов телекомунникационной компании](https://public.tableau.com/app/profile/julia3616/viz/yp_16722938062050/Dashboard1#1 ) |Разрабатываем  дашборд для анализа результатов опроса клиентов компании (Tableau Public)|`Python` `PostgreSQL` `Tableau` `продуктовые метрики` `построение дашбордов`|
